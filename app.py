...
@st.cache_data
def load_data():
    df = pd.read_parquet("C:\\Users\\sanja\\OneDrive\\Desktop\\invoices.parquet")
...
# === Tabs Layout ===
tab1, tab2, tab3, tab4 = st.tabs(["📈 Trends", "👤 Customers", "📅 Weekday", "🔁 Retention"])
...
with tab3:
    st.subheader("📅 Weekday Invoice Patterns")
...
@st.cache_data
def load_raw():
    df_raw = pd.read_csv("C:\\Users\\sanja\\OneDrive\\Desktop\\cleaned_retail.csv", encoding='ISO-8859-1')
